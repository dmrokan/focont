...
Furthermore, the algorithm can be used to calculate fixed-order controllers. Please, check [tests](./tests/test_01.py) for examples and [docs](./doc/focont.md) for detailed information.
